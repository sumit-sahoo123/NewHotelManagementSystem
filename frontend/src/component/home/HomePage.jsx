...
const HomePage = () => {
    ...
    return (
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    ...
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Starlight Palace</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Starlight Palace</span></h2>
